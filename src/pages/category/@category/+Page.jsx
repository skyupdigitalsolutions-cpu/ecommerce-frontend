    ...
    <section className="w-full bg-white">
      <div className="px-5 py-10 sm:px-8 sm:py-6 lg:px-0">
          ...
          {["All", ...category.items].map((chip) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => setSub(chip)}
                className={`rounded-full border px-4 py-2 text-[13px] font-semibold transition ${on ? "border-[#0037CA] bg-[#0037CA] text-white" : "border-slate-200 bg-white text-[#475467] hover:border-[#0037CA] hover:text-[#0037CA]"}`}
              >
                {chip}
              </button>
            );
        ...
        {visible.length > 0 ? (
          ...
          <div className="mt-16 mx-12 text-center text-[#667085]">
