  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto max-w-[1400px] px-5 py-10 sm:px-8 sm:py-12 lg:px-12">
        <nav className="mb-4 text-[13px] text-[#98A2B3]"><a href="/" className="hover:text-[#0037CA]">Home</a><span className="mx-1.5">/</span><span className="text-[#475467]">All Categories</span></nav>
          ...
          {groups.map(({ cat, products }) => (
            <div key={cat.slug}>
              <div className="mb-5 flex items-end justify-between gap-4">
                ...
                <a href={`/category/${cat.slug}`} className="flex-none text-sm font-semibold text-[#0037CA] hover:text-[#1c4fd6]">View all →</a>
              </div>
