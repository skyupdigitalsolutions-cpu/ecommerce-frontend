...
export default function DiscoverTrending() {
  ...
  const items = [...products].sort((a, b) => b.rating - a.rating).slice(0, 10);
  if (items.length === 0) return null;
  return (
    <section className="w-full bg-white py-8 sm:py-10">
      <div className="mx-12 px-5 sm:px-8 lg:px-12">
        <div className="mb-6"><p className="text-[12px] font-bold uppercase tracking-widest text-[#2F6BFF]">Trending</p><h2 className="mt-1 text-2xl font-bold tracking-tight text-[#0F1729] sm:text-[38px]">Discover what's trending</h2></div>
